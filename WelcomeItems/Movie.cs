...
namespace WelcomeItems
{
    class Movie : Item
    {
        ...
        public Movie(string Title, int Supply, double Dollar) : base(Title, "Movie", Supply, Dollar) { }
        ...
        int SellingNumber(int num)
        {
            ...
            int stock;
            Console.WriteLine("That movie is in stock.");
            Console.WriteLine("We have {0} in stock at {1} per rotating saucer.", num, Price.ToString("C", CultureInfo.CurrentCulture));
